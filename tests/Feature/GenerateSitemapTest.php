...
class GenerateSitemapTest extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $this->config->set('routetree.sitemap.route.enabled', true);
    }
    ...
    public function test_simple_sitemap_via_route()
    {
        ...
        $this->assertXmlStringEqualsXmlString($this->get('sitemap.xml')->baseResponse->content(), '<?xml version="1.0" encoding="UTF-8"?>
